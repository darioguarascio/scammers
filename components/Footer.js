      ...
      <div className="bg-gray p-4 py-5">
        <div className="container px-4 mx-auto grid grid-cols-3">
          <div className="col-span-1">
            <strong className="text-xl font-bolder text-white">Truffatori</strong>
          </div>
...
<footer className="bg-gray pt-12 pb-10 lg:pb-20 relative z-10 text-gray-400 px-4">
   <div className="container mx-auto">
      <div className="flex flex-wrap -mx-4">
         <div className="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div className="w-full mb-10">
              <strong className="text-xl font-bolder text-white mb-6 block">Truffatori.info</strong>
